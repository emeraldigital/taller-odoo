...
class TestSaleOrder(TransactionCase):
    ...
    # 
    # test draft: project won't be generated
    # test sent: project won't be generated
    # test sale: project will be generated
    # test done: project won't be generated
    # test cancel: project won't be generated
    # test all states: project will be at 'sale' and 'done' states
